    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_no', models.CharField(max_length=4)),
                ('description', models.CharField(default='Maintenance Charge', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('room_no', models.CharField(max_length=4)),
                ('status', models.CharField(choices=[('ว่าง', 'ว่าง'), ('จอง', 'จอง')], default='ว่าง', max_length=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adjust', models.DecimalField(decimal_places=2, default=0, max_digits=7)),
                ('bill_ref', models.CharField(blank=True, max_length=6)),
